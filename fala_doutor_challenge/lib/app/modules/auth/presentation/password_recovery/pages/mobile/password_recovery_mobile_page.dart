...
class PasswordRecoveryMobilePage extends StatefulWidget {
  ...
  const PasswordRecoveryMobilePage({
    super.key,
  ...
  @override
  State<PasswordRecoveryMobilePage> createState() =>
      _PasswordRecoveryMobilePageState();
}

class _PasswordRecoveryMobilePageState
    extends State<PasswordRecoveryMobilePage> {
  @override
